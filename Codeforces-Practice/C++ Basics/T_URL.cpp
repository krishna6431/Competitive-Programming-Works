...
string extractParameterValue(const string &url, const string &parameter)
{
    size_t start = url.find(parameter + "=");
    if (start != string::npos)
    {
        start += parameter.length() + 1;
        size_t end = url.find('&', start);
        return url.substr(start, (end != string::npos) ? (end - start) : string::npos);
    }
    return "";
}
void HarHarMahadev()
{
    ...
    cout << "username: " << extractParameterValue(url, "username") << endl;
    cout << "pwd: " << extractParameterValue(url, "pwd") << endl;
    cout << "profile: " << extractParameterValue(url, "profile") << endl;
    cout << "role: " << extractParameterValue(url, "role") << endl;
    cout << "key: " << extractParameterValue(url, "key") << endl;
}
