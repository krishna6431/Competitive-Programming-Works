...
// idea is to keep dividing power of twos from all the elements and then check if all the elements are equal or not
// somewhere power of 2s will work because if LSB is same for all next MSB has two options either 0 or 1
void HarHarMahadev()
{
    ll n;
    cin >> n;
