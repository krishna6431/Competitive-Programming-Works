...
void HarHarMahadev()
{
    ...
    // dp[i][k] = no of prefix of length i that can be formed such tha the last element of the prefix is K
    // base case dp[1][k] = 1 if v[1] == 0 or v[1] == k else 0
    for (int i = 2; i <= n; i++)
    {
        for (int k = 1; k <= m; k++)
        {
