...
int main()
{
    ...
    int k1 = 2;
    vector<vector<int>> output_1 = {{1, 1, 3}, {3, 4, 5}, {7, 8, 9}};
    if (leetcode2IDE.divideArray(nums1, k1) == output_1)
    {
    ...
    int k2 = 3;
    vector<vector<int>> output_2 = {};
    if (leetcode2IDE.divideArray(nums2, k2) == output_2)
    {
