...
int main()
{
    ...
    int output_1 = 15;
    if (leetcode2IDE.largestPerimeter(nums1) == output_1)
    {
    ...
    vector<int> nums2 = {1, 12, 1, 2, 5, 50, 3};
    int output_2 = 12;
    if (leetcode2IDE.largestPerimeter(nums2) == output_2)
    {
    ...
    vector<int> nums3 = {5, 5, 50};
    int output_3 = -1;
    if (leetcode2IDE.largestPerimeter(nums3) == output_3)
    {
