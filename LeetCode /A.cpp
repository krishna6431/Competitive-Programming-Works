...
int main()
{
    ...
    int output_1 = 10;
    if (leetcode2IDE.incremovableSubarrayCount(nums1) == output_1)
    {
    ...
    int output_2 = 7;
    if (leetcode2IDE.incremovableSubarrayCount(nums2) == output_2)
    {
    ...
    int output_3 = 3;
    if (leetcode2IDE.incremovableSubarrayCount(nums3) == output_3)
    {
