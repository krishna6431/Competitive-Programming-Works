...
// Generated by LeetCodeContestHelper at 07/07/2024, 08:06:26
// 100359. ans Submatrices With Equal Frequency of X and Y
// https://leetcode.com/contest/weekly-contest-405/problems/ans-submatrices-with-equal-frequency-of-x-and-y/
...
{
public:
    vector<vector<int>> prefSum(vector<vector<char>> &grid, char target)
    {
        int n = grid.size();
        int m = grid[0].size();
    ...
    int numberOfSubmatrices(vector<vector<char>> &grid)
    {
        ...
        auto prefX = prefSum(grid, 'X');
        auto prefY = prefSum(grid, 'Y');

        for (int r2 = 0; r2 < n; ++r2)
        {
            for (int c2 = 0; c2 < m; ++c2)
            {
                int x = getSum(prefX, 0, 0, r2, c2);
                int y = getSum(prefY, 0, 0, r2, c2);
                if (x > 0 && x == y)
                {
                    ++ans;
                }
...
// int Solution::numberOfSubmatrices(vector<vector<char>> grid)

int main()
{
    cout << "*** 100359. ans Submatrices With Equal Frequency of X and Y ***" << endl
         << endl;
...

    {
        ...
        int ans0 = s0.numberOfSubmatrices(grid);
        int exp0 = 3;
...

    {
        ...
        int ans1 = s0.numberOfSubmatrices(grid);
        int exp1 = 0;
...

    {
        ...
        int ans2 = s0.numberOfSubmatrices(grid);
        int exp2 = 0;
