...
int main()
{
    ...
    vector<int> nums1 = {8, 10, 6, 12, 9, 12, 2, 3, 13, 19, 11, 18, 10, 16};
    int output_1 = 8;
    if (leetcode2IDE.maxSelectedElements(nums1) == output_1)
    {
    ...
    vector<int> nums2 = {1, 4, 7, 10};
    int output_2 = 1;
    if (leetcode2IDE.maxSelectedElements(nums2) == output_2)
    {
