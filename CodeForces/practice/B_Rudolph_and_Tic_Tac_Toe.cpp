...
void HarHarMahadev()
{
    ...
    if (grid[1][0] == grid[1][1] and grid[1][1] == grid[1][2] and grid[1][0] != '.')
    {
        ans = grid[1][0];
    }
    if (grid[2][0] == grid[2][1] and grid[2][1] == grid[2][2] and grid[2][0] != '.')
    {
        ans = grid[2][0];
    }

    if (grid[0][0] == grid[1][0] and grid[1][0] == grid[2][0] and grid[0][0] != '.')
    {
        ans = grid[0][0];
    }
    ...
    if (grid[0][2] == grid[1][2] and grid[1][2] == grid[2][2] and grid[0][2] != '.')
    {
        ans = grid[0][2];
    }
    ...
    if (grid[2][0] == grid[1][1] and grid[0][2] == grid[2][0])
    {
        if (grid[2][0] != '.')
        {
            ans = grid[2][0];
