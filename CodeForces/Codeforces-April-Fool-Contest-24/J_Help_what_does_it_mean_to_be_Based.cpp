...
void HarHarMahadev()
{
    ...
    cout << "simp for 9\n";
    cout << "\n";
    cout << "bruh swapped is lowkey just 1\n";
    cout << "\n";
    cout << "while swapped ratios 1\n";
    cout << "    bruh swapped is lowkey just 0\n";
    ...
    cout << "    vibe check n ratios i\n";
    cout << "    simp for 9\n";
    cout << "    while i ratios n\n";
    cout << "        bruh temp is lowkey just a[i-1]\n";
    cout << "        bruh temp2 is lowkey just a[i]\n";
    cout << "        vibe check temp ratios temp2\n";
    cout << "        simp for 9\n";
    cout << "        bruh a[i-1] is lowkey just temp2\n";
    cout << "        bruh a[i] is lowkey just temp\n";
    cout << "        simp for 5\n";
    cout << "        i++\n";
    cout << "        j++\n";
    cout << "        bruh swapped is lowkey just 1\n";
    ...
    cout << "\n";
    cout << "bruh result is lowkey just a[k-1]\n";
    cout << "yeet result\n";
    cout << "go touch some grass\n";
}
