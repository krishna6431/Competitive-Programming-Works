...
pair<bool, vll> solve(vll &a, vll &b, vll &c)
{
    ll total = 0;
    for (auto &x : a)
    {
...
void HarHarMahadev()
{
    ...
    auto ans = solve(alice, bob, charlie);
    if (ans.first)
    {
