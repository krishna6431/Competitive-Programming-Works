...
void HarHarMahadev()
{
    ...
    // dp[i] = longest inc subs ending at ith index;
    // cnt[i] = count of lis having length dp[i];
    dp[0] = 1;
    cnt[0] = 1;
    for (int i = 1; i < n; i++)
    {
