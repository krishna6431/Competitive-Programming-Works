...
void dfs(ll i, ll j, ll &cmpNo, ll &sz)
{
    if (i < 0 or j < 0 or i >= n or j >= m or visited[i][j] == cmpNo or graph[i][j] == 1)
    {
        return;
    }
    visited[i][j] = cmpNo;
